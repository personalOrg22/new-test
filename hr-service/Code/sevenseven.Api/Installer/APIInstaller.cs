...
using ElmahCore.Mvc;
using ElmahCore;
using sevenseven.Api.Filters;
using sevenseven.Business.Installer;

namespace sevenseven.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "sevenseven API", Version = version + "-" + branch});
            });
