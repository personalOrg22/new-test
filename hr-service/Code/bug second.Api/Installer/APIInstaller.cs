...
using ElmahCore.Mvc;
using ElmahCore;
using bug second.Api.Filters;
using bug second.Business.Installer;

namespace bug second.Api.Installer
{
    public class APIInstaller
    {
        ...
        public void Install()
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "bug second API", Version = version + "-" + branch});
            });
